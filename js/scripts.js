(function() {
    ...
    $("html").niceScroll({styler:"fb",cursorcolor:"rgb(232, 84, 165)", cursorwidth: '4', cursorborderradius: '10px', background: '#FFFFFF', spacebarenabled:false, cursorborder: '0',  zindex: '1000'});
